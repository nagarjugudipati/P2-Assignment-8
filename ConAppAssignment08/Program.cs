    ...
    internal class Program
    {
        ...
        public static void DisplayEmployeeRecords()
        {
            foreach (Employee e in db.Employees)
            {
                ...
                Console.WriteLine("Salary :" + e.BirthDate);
                Console.WriteLine("Desidnation :" + e.Salary);
                Console.WriteLine("------------------- ");
